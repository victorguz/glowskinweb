...
export const SERVICES_PRICING: PricingCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: cop(140_000),
        detail:
          'Protocolo ultra-suave para pieles reactivas o con rosácea.',
      },
      {
        name: 'Limpieza Facial HydraGlow',
        price: cop(250_000),
        detail:
          'Tecnología Hydrafacial combinada con activos seleccionados.',
      },
      {
  ...
  },
  {
    ...
    description: 'Tratamientos especializados para el control y eliminación del acné.',
    items: [
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: cop(1_200_000),
        detail:
          'Bioestimulación celular con micropunciones y alta nutrición.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        price: cop(1_200_000),
        detail:
          'Reparación intensiva de cicatrices, arrugas y flacidez.',
      },
      {
        name: 'Tratamiento 3 Sesiones Exosomas',
        price: cop(2_700_000),
        detail:
          'Máximo beneficio regenerativo con protocolo de choque.',
      },
    ],
  },
  {
    ...
    description:
      'Reparación del ADN celular con polinucleótidos de salmón.',
    items: [
      {
        name: 'Protocolo PDRN Rejuvenecimiento Intensivo',
        price: cop(900_000),
        detail:
          'Restaura firmeza, elasticidad y atenúa arrugas finas.',
      },
      {
        name: 'Tratamiento 3 Sesiones PDRN',
        price: cop(2_100_000),
        detail:
          'Resultados duraderos en firmeza y calidad de la piel.',
      },
    ],
  },
  {
    category: 'Cuidado de Labios',
    description: 'Tratamientos para revitalizar y mejorar la apariencia de los labios.',
    items: [
      {
        name: 'Glow Lips',
        price: cop(120_000),
      ...
      },
      {
        ...
        price: cop(300_000),
        detail:
          'Resultado óptimo y duradero en la revitalización labial.',
      },
    ],
  },
];