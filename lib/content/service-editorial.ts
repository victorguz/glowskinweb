...
function facialArticle(): NonNullable<ServiceEditorialBlock['relatedArticle']> {
  return { href: BLOG_FACIAL_HREF, title: BLOG_FACIAL_TITLE, excerpt: BLOG_FACIAL_EXCERPT };
}

function blogIndexArticle(): NonNullable<ServiceEditorialBlock['relatedArticle']> {
  return {
    href: '/blog',
    title: 'Blog Glow Skin',
    excerpt: 'Artículos sobre ciencia del cuidado facial, protocolos y bienestar de la piel.',
  };
}
...
const BY_ID: Record<string, ServiceEditorialBlock> = {
  'limpieza-facial': {
    ...
    title: 'Más allá de una rutina en casa',
    subtitle: 'Lo que aporta un facial profesional en el estudio',
    paragraphs: [
      'La piel refleja salud y descanso; la polución y el estrés oxidativo dejan capas que en casa cuesta retirar por completo. Por eso combinamos extracción manual aséptica, vapor, ultrasonido y pasos de nutrición según tu diagnóstico.',
      'En nuestros casos reales se ve cómo una descarga completa de impurezas devuelve luminosidad: no es solo estética, es equilibrar la barrera cutánea con activos que calman e hidratan mientras limpian.',
      'La constancia respeta el ciclo de renovación: un facial profesional cada unas cuatro semanas ayuda a mantener resultados en el tiempo, siempre adaptando técnica a tu piel actual.',
    ],
    quote: {
      text: 'La constancia es el ingrediente secreto. Un facial profesional cada 28 días respeta el ciclo de renovación natural de la piel.',
  ...
  'limpieza-facial-anti-acne': {
    ...
    title: 'Control sebáceo sin descuidar la barrera',
    paragraphs: [
      ...
      'Como en una limpieza facial de autor, el diagnóstico guía la intensidad: una piel con acné inflamatorio no recibe el mismo protocolo que una con comedones y poca irritación.',
      'Si tu objetivo es mejorar textura y brotes de forma sostenida, combinar sesiones en estudio con hábitos en casa multiplica resultados; en el blog profundizamos en el rol del facial profesional como base de ese camino.',
    ],
    relatedArticle: facialArticle(),
  },
  ...
  'antiox-peel-pro': {
    eyebrow: 'Luminosidad',
    title: 'Peeling antioxidante para pieles apagadas',
    paragraphs: [
      'Combate radicales libres, mejora la sensación de “piel cansada” y prepara el cutis para otros tratamientos. Es un recurso frecuente en protocolos de glow rápido.',
      'Valoramos si tienes sensibilidad o uso reciente de retinoides antes de aplicar, para respetar la barrera.',
    ],
    relatedArticle: facialArticle(),
  },
  'porcelanizacion-facial': {
    eyebrow: 'Efecto glow',
    title: 'Unifica tono y refina la superficie',
    paragraphs: [
      'Busca un acabado más homogéneo y luminoso con pasos de renovación suave y sellado nutritivo. Muy demandado antes de eventos o como mantenimiento.',
      'No sustituye una limpieza profunda cuando hay mucha retención de sebo; en esos casos a veces conviene ordenar primero la higiene facial.',
    ],
    relatedArticle: facialArticle(),
  },
