...
const ASSETS = {
  ...
  cases: [
    {
      url: `${BASE_IMG_URL}/cases/caso-1-tratamiento-anti-manchas.webp`,
      title: "Tratamiento Anti-manchas",
    },
    {
      url: `${BASE_IMG_URL}/cases/caso-2-tratamiento-anti-acne.webp`,
      title: "Control de Acné Severo",
    },
    {
      url: `${BASE_IMG_URL}/cases/caso-3-tratamiento-revitalizacion.webp`,
      title: "Revitalización Facial",
    },
    {
      url: `${BASE_IMG_URL}/cases/caso-4-tratamiento-anti-acne.webp`,
      title: "Limpieza Profunda",
    },
    {
      url: `${BASE_IMG_URL}/cases/caso-5-tratamiento-anti-acne-2.webp`,
      title: "Acné Quístico",
    },
    {
      url: `${BASE_IMG_URL}/cases/caso-6-revitalizacion.webp`,
      title: "Efecto Glow Inmediato",
    },
  ],
};
...
const REVIEWS = [
  {
    name: "Karla Ramírez",
    text: "Sofi es una profesional excepcional. Me ayudó a combatir un acné persistente cuando ya nada funcionaba. Su conocimiento y trato son inigualables.",
    time: "hace un mes",
  },
  {
    name: "Edgar Arrieta",
    text: "El cambio en mi piel fue inmediato. No solo el aspecto físico, sino la sensación de frescura y limpieza es algo que nunca había experimentado en otros sitios.",
    time: "hace un mes",
  },
  {
    name: "Samara Chartuni",
    text: "Atención personalizada de verdad. Te explica cada paso y el porqué de cada producto. Es mi momento favorito del mes para consentirme.",
    time: "hace 3 semanas",
  },
];
...
export default function OtraPage() {
  ...
  const [activeCase, setActiveCase] = useState<
    (typeof ASSETS.cases)[number] | null
  >(null);
  ...
  return (
    <div className="min-h-screen bg-[#fbf6f3] font-sans text-[#4a3221] selection:bg-[#7d5a44] selection:text-white">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-20">
          <div className="max-w-4xl">
            <div className="overflow-hidden mb-6">
              <span className="block tracking-[0.4em] text-[#a5846e] font-black text-xs uppercase animate-reveal">
                Estética Facial de Autor
              </span>
            </div>
            <h1 className="text-7xl md:text-[10rem] font-serif leading-[0.85] text-[#5c3a21] mb-12 tracking-tighter">
              Bespoke <br />{" "}
              <span className="italic font-light opacity-80">Radiance</span>
            </h1>
            <p className="text-xl md:text-2xl font-light text-[#7d5a44] max-w-xl mb-12 leading-relaxed text-balance">
              Transformamos la salud de tu piel con protocolos clínicos
              diseñados exclusivamente para tu tipo de cutis.
            </p>
            <BookingCtaButtons
              className="flex flex-wrap gap-4 items-center"
              reserveHereClassName="bg-[#5c3a21] text-white px-10 py-6 rounded-full font-bold uppercase tracking-[0.2em] hover:bg-[#a5846e] transition-all shadow-2xl"
              reserveWhatsappClassName="bg-white text-[#5c3a21] border border-[#5c3a21]/25 px-10 py-6 rounded-full font-bold uppercase tracking-[0.2em] hover:bg-[#f7f0eb] transition-all shadow-xl"
            />
          </div>
        </div>
      </section>
      ...
      <section id="nosotros" className="py-32 container mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-5 order-2 lg:order-1">
            <h2 className="text-5xl md:text-7xl font-serif text-[#5c3a21] mb-10 leading-none">
              Tu piel es <br /> nuestro lienzo.
            </h2>
            <p className="text-xl text-[#7d5a44] leading-relaxed mb-12">
              Liderado por{" "}
              <span className="text-[#5c3a21] font-bold">Sofía Nieto</span>,
              experta en Cosmiatría avanzada, Glow Skin nace de la pasión por la
              armonía facial y el rigor científico.
            </p>
            ...
            <div className="space-y-8">
              {[
                {
                  icon: Award,
                  title: "Certificación Clínica",
                  text: "Expertos en Cosmetología y Cosmiatría de vanguardia.",
                },
                {
                  icon: Leaf,
                  title: "Activos Premium",
                  text: "Selección rigurosa de productos respetuosos con tu barrera cutánea.",
                },
                {
                  icon: Zap,
                  title: "Resultados Visibles",
                  text: "Cambios reales y tangibles desde el primer tratamiento.",
                },
              ].map((item, i) => (
                <div key={i} className="flex gap-6 group">
                  ...
                  <div>
                    <h4 className="font-black uppercase tracking-widest text-xs text-[#5c3a21] mb-2">
                      {item.title}
                    </h4>
                    <p className="text-sm text-[#7d5a44]/80 leading-relaxed">
                      {item.text}
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 relative">
            ...
            <div className="absolute -bottom-10 -left-10 bg-white p-10 rounded-[3rem] shadow-2xl border border-[#f1e4dc] hidden xl:block">
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-[#a5846e]">
                Reviews en Google
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="mb-24 flex flex-col md:flex-row justify-between items-end gap-8">
            <div className="max-w-2xl">
              <span className="text-[#a5846e] font-black tracking-[0.4em] text-[10px] uppercase mb-4 block">
                Especialidades
              </span>
              <h2 className="text-6xl md:text-8xl font-serif text-[#5c3a21] leading-[0.9]">
                Nuestros <br /> Métodos
              </h2>
            </div>
            <p className="text-[#7d5a44] max-w-xs text-right text-lg font-light leading-relaxed">
              Curaduría de tratamientos estéticos con enfoque clínico para
              ...
              <div key={idx} className="group cursor-pointer">
                ...
                <div className="flex justify-between items-start gap-4">
                  <div className="flex-1">
                    <h3 className="text-4xl font-serif text-[#5c3a21] mb-4 group-hover:text-[#a5846e] transition-colors">
                      {method.title}
                    </h3>
                    <p className="text-[#7d5a44] text-lg font-light leading-relaxed max-w-lg">
                      {method.desc}
                    </p>
                  </div>
                  <div className="text-[4rem] font-serif text-[#f1e4dc] select-none">
                    0{idx + 1}
                  </div>
                </div>
              </div>
      ...
      <section id="casos" className="py-32 bg-[#5c3a21] text-white">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-24">
            ...
            <p className="text-[#a5846e] tracking-[0.3em] font-black uppercase text-xs mt-6">
            ...
            {ASSETS.cases.map((item, i) => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-10 bg-gradient-to-t from-black/90 via-black/30 to-transparent translate-y-6 group-hover:translate-y-0 transition-transform duration-500">
                  <p className="text-xs uppercase tracking-[0.3em] font-black text-[#a5846e] mb-2">
                    Protocolo Glow Skin
                  </p>
      ...
      <section id="testimonios" className="py-32 bg-white overflow-hidden">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="flex flex-col items-center text-center">
            <MessageCircle
              size={48}
              className="text-[#a5846e] mb-12 opacity-30"
            />
            <div className="relative max-w-4xl mx-auto min-h-[300px] flex items-center">
              {REVIEWS.map((review, i) => (
                <div
                  key={i}
                  className={`transition-all duration-1000 flex flex-col items-center ${i === activeReview ? "opacity-100 relative" : "opacity-0 absolute inset-0 pointer-events-none"}`}
                >
                  <p className="text-3xl md:text-5xl font-serif text-[#5c3a21] leading-tight mb-12 italic">
                    {review.text}
                  </p>
                  <div>
                    <p className="font-black uppercase tracking-[0.2em] text-xs text-[#a5846e] mb-1">
                      {review.name}
                    </p>
                    <p className="text-sm text-[#7d5a44]/60 font-medium">
                      {review.time}
                    </p>
                  </div>
                </div>
      ...
      <section className="relative py-40 overflow-hidden bg-[#fbf6f3]">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h2 className="text-6xl md:text-[8rem] font-serif text-[#5c3a21] mb-16 leading-none tracking-tighter">
            Your Skin, <br />{" "}
            <span className="italic font-light opacity-80 text-[#a5846e]">
              Redefined.
            </span>
          </h2>
          <BookingCtaButtons
            className="flex flex-col sm:flex-row gap-4 justify-center"
            reserveHereClassName="bg-[#a5846e] text-white px-16 py-7 rounded-full font-black text-xs uppercase tracking-[0.3em] hover:bg-[#5c3a21] transition-all shadow-2xl hover:-translate-y-2"
            reserveWhatsappClassName="bg-white text-[#5c3a21] px-16 py-7 rounded-full font-black text-xs uppercase tracking-[0.3em] hover:bg-[#f0e4db] transition-all shadow-xl hover:-translate-y-2 border border-[#f1e4dc]"
          />
        </div>
      </section>
      ...
      {activeCase && (
        <div
          className="fixed inset-0 z-[200] bg-black/95 flex items-center justify-center p-6 animate-fadeIn"
        ...
        >
          ...
          >
            ...
            <div className="mt-8 text-center">
              <p className="text-[#a5846e] font-black tracking-[0.3em] text-xs uppercase mb-2">
                Protocolo Clínico
              </p>
