...
import { ChevronRight, Sparkles, Award, Zap, MessageCircle } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-12 gap-24 items-center">
          <div className="lg:col-span-6 relative order-2 lg:order-1">
            ...
            <div className="relative aspect-[4/5] overflow-hidden rounded-[4rem] shadow-[0_40px_100px_rgba(74,50,33,0.15)] group">
              <img src={ASSETS.sofia} alt="Sofía Nieto - cosmiatría y limpieza facial en Barranquilla" className="w-full h-full object-cover transition-all duration-1000 group-hover:scale-105" />
            </div>
