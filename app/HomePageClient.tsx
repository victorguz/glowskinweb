...
export default function HomePageClient() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f0eb] font-sans text-[#4a3221] overflow-x-hidden selection:bg-[#d4b499] selection:text-white">
        ...
        <div className="container mx-auto px-6 relative z-20">
          <div className="flex flex-col items-center animate-reveal">
            ...
            <h1 className="text-6xl md:text-[9.5rem] font-serif leading-none tracking-tighter text-[#4a3221] ">
              Devuélvele el
              <span className="block font-script text-6xl md:text-[8rem] text-[#c98d61] -mt-4 md:-mt-12">
                Glow a tu Piel
              </span>
            </h1>
            ...
            <p className="text-lg md:text-2xl font-medium text-[#7d5a44] max-w-2xl leading-relaxed italic tracking-wide text-balance px-4">
              Somos un Centro de Estética Facial especializados en la
              Restauración de tu Piel.
            </p>
            <small>
              Estamos ubicados en Barranquilla — Carrera 50 # 74-120, Alto
              Prado.
            </small>
            <BookingCtaButtons
      ...
      <section id="servicios" className="py-40 bg-white">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-32">
            ...
            <h2 className="text-5xl md:text-8xl font-serif text-[#4a3221] tracking-tighter">
              Métodos Propios
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {ASSETS.methods.map((t, idx) => (
              <div
                key={idx}
                className="group relative h-[600px] overflow-hidden rounded-[2.5rem] shadow-2xl"
              >
                <img
                  src={t.img}
                  alt={t.title}
      ...
      <section
        id="filosofia"
        className="py-40 bg-[#f7f0eb] container mx-auto px-6 lg:px-12"
      >
        <div className="grid lg:grid-cols-12 gap-24 items-center">
          <div className="lg:col-span-6 relative order-2 lg:order-1">
            ...
            <div className="relative aspect-[4/5] overflow-hidden rounded-[4rem] shadow-[0_40px_100px_rgba(74,50,33,0.15)] group">
              <img
                src={ASSETS.sofia}
                alt="Sofía Nieto - cosmiatría y limpieza facial en Barranquilla"
            ...
            <div className="absolute -bottom-8 -right-8 bg-[#4a3221] p-10 rounded-[3rem] shadow-2xl text-[#f7f0eb] hidden xl:block">
              <p className="text-4xl font-serif mb-2 leading-none tracking-tighter">
                Sofía Nieto
              </p>
          ...
          <div className="lg:col-span-6 order-1 lg:order-2">
            ...
            <div className="space-y-6 text-xl text-[#7d5a44] leading-relaxed mb-12 font-medium opacity-90">
              ...
              <p>
                ...
                Cosmiatría, y estoy comprometida con un servicio basado en el
                cuidado, el conocimiento y el profesionalismo.
              </p>
              <p className="italic text-[#4a3221]">
                &ldquo;En Glow Skin, cada tratamiento es personalizado y pensado
                para ayudarte a alcanzar la mejor versión de ti.&rdquo;
              </p>
            </div>
              ...
              {[
                {
                  icon: Award,
                  title: "Certificación",
                  text: "Especialista en Cosmetología y Cosmiatría.",
                },
                {
                  icon: Zap,
                  title: "Resultados",
                  text: "Transformaciones visibles desde la primera sesión.",
                },
              ].map((item, i) => (
                <div key={i} className="group">
                  ...
                  <p className="text-sm text-[#7d5a44] font-medium pl-9 opacity-80">
                    {item.text}
                  </p>
                </div>
              ))}
      ...
      <section
        id="testimonios"
        className="py-32 bg-white overflow-hidden border-y border-[#d4b499]/10"
      >
        <div className="container mx-auto px-6 lg:px-12">
          <div className="flex flex-col items-center text-center">
            <MessageCircle
              size={48}
              className="text-[#d4b499] mb-8 opacity-30"
              aria-hidden
            />
            <p className="text-[10px] font-black uppercase tracking-[0.5em] text-[#d4b499] mb-4">
              Reseñas
            </p>
            <h2 className="text-4xl md:text-6xl font-serif text-[#4a3221] tracking-tighter mb-4">
              Lo que ellas dicen
            </h2>
            ...
            <div className="relative max-w-4xl mx-auto min-h-[260px] sm:min-h-[300px] md:min-h-[340px] w-full flex items-center justify-center">
              {REVIEWS.map((review, i) => (
                ...
                >
                  ...
                  <div>
                    <p className="font-black uppercase tracking-[0.2em] text-xs text-[#d4b499] mb-1">
                      {review.name}
                    </p>
              ...
              {REVIEWS.map((_, i) => (
                <button
                  ...
                  className={`h-1 transition-all duration-500 rounded-full ${
                    i === activeReview
                      ? "bg-[#4a3221] w-12"
                      : "bg-[#d4b499]/40 w-4 hover:bg-[#d4b499]"
                  }`}
                />
              ))}
            </div>
      ...
      <section className="relative py-48 bg-[#4a3221] text-[#f7f0eb] overflow-hidden">
        <div className="container mx-auto px-6 text-center relative z-10">
          <Sparkles
            size={40}
            className="mx-auto mb-10 text-[#d4b499] opacity-50"
          />
          <h2 className="text-5xl md:text-8xl font-serif mb-12 leading-[1.1] tracking-tighter max-w-5xl mx-auto">
            ¿Qué esperas para <br />{" "}
            <span className="italic font-light opacity-90 text-[#d4b499]">
              devolverle el Glow a tu Piel?
            </span>
          </h2>
          <BookingCtaButtons
            className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center"
            reserveHereClassName="bg-[#f7f0eb] text-[#4a3221] px-12 py-7 rounded-full font-black text-xs uppercase tracking-[0.3em] hover:bg-[#d4b499] transition-all shadow-2xl"
            reserveWhatsappClassName="bg-transparent text-[#f7f0eb] border border-white/30 px-12 py-7 rounded-full font-black text-xs uppercase tracking-[0.3em] hover:bg-white/10 transition-all"
          />
        </div>
      </section>
