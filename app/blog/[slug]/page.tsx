      ...
      <div className="min-h-screen bg-[#f7f0eb] font-sans text-[#4a3221] selection:bg-[#d4b499] selection:text-white">
        ...
        <article className="container mx-auto px-6 max-w-3xl pb-24">
          ...
          <footer className="mt-16 pt-10 border-t border-[#4a3221]/10">
            <p className="text-sm text-[#7d5a44] leading-relaxed">
              ¿Quieres una valoración personalizada en{' '}
              <strong className="text-[#4a3221]">Glow Skin</strong>? Escríbenos por WhatsApp desde la página principal
              o visita nuestra sección de{' '}
              <Link href="/precios" className="text-[#d4b499] font-bold underline-offset-4 hover:underline">
                precios
              </Link>
              .
            </p>
