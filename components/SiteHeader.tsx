...
import { SITE_LOGO_URL, WA_LINK } from '@/components/site-config';
...
const NAV_LINKS: { label: string; href: string; match: (path: string) => boolean }[] = [
  ...
  { label: 'Filosofía', href: '/#filosofia', match: () => false },
...
export function SiteHeader() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 bg-white z-[60] flex flex-col items-center justify-center transition-all duration-700 lg:hidden ${
